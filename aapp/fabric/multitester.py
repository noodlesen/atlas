...
def multitest(f, params, **kwargs):
    ...
    if trades:
        ...
        for t in trades:
            ...
            #     draw_chart(
            #         t.data,
            #         ('images/'+t.symbol+str(i)+'_'+t.direction+'_'+t.close_reason),
            #         context
            #     )
        ...
        res['WINS_TO_LOSES'] = (
            number_of_wins / number_of_loses if number_of_loses > 0 else None
        )
        res['WINRATE'] = (
            number_of_wins / number_of_trades if number_of_trades > 0 else None
        )
